...
object DummyGenerator {
    ...
    fun generateDummyMovies(): List<MoviesData> {
        ...
        movies.add(
            MoviesData("1", "The Tomorrow War", "July 1, 2021", "Action, Science Fiction","82%",
        ...
        movies.add(
            MoviesData("2", "Peter Rabbit 2: The Runaway", "June 18, 2021", "Family, Comedy, Adventure, Animation, Fantasy","73%",
        ...
        movies.add(
            MoviesData("3","Jungle Cruise", "July 30, 2021", "Adventure, Fantasy, Comedy, Action", "83%",
        ...
        movies.add(
            MoviesData("4", "Space Jam: A New Legacy", "July 16, 2021", "Animation, Comedy, Family, Science Fiction", "77%",
        ...
        movies.add(
            MoviesData("5","F9","June 16, 2021","Action, Crime, Thriller","79%",
            "Dominic Toretto and his crew battle the most skilled assassin and high-performance driver they've ever encountered: his forsaken brother.",
            "Justin Lin","https://www.themoviedb.org/t/p/w1280/bOFaAXmWWXC3Rbv4u4uM9ZSzRXP.jpg")
        )
        movies.add(
            MoviesData("6","The Forever Purge","July 2, 2021","Adventure, Thriller, Action, Horror, Western","78%",
        ...
        movies.add(
            MoviesData("7","The Boss Baby","June 2, 2021","Animation, Comedy, Adventure, Family","79%",
        ...
        movies.add(
            MoviesData("8","Luca","June 17, 2021","Animation, Comedy, Family, Fantasy","81%",
        ...
        movies.add(
            MoviesData("9","Infinite","June 10, 2021","Science Fiction, Action, Thriller","72%",
        ...
        movies.add(
            MoviesData("10","Dynasty Warriors","April 29, 2021","Action, Adventure, Family","66%",
        ...
        movies.add(
            MoviesData("11","Trollhunters: Rise of the Titans","July 21, 2021","Animation, Fantasy, Family,, Action, Adventure, Science Fiction","80%",
        ...
        movies.add(
            MoviesData("12","Wrath of Man","May 7, 2021","Crime, Action, Thriller","79%",
    ...
    fun generateDummyMovieRecommendation(idSelectedMovie: String): List<RecommendationData> {
        val dataRecommendation = ArrayList<RecommendationData>()
        val map = HashMap<Int, Int>()
        val listMovie = generateDummyMovies()
        val sizeList = listMovie.size - 1
        var randomInt = Random.nextInt(0, sizeList)
        for (i in 1..5) {
            if (map.containsKey(randomInt) || listMovie[randomInt].moviesId == idSelectedMovie) {
                while (map.containsKey(randomInt) || listMovie[randomInt].moviesId == idSelectedMovie ) {
                    randomInt = Random.nextInt(0, sizeList)
                }
            }
            map[randomInt] = randomInt
            val itemMovie = listMovie[randomInt]
            dataRecommendation.add(
                RecommendationData(i.toString(), itemMovie.title, itemMovie.moviesId,
                itemMovie.imagePath, itemMovie.released, itemMovie.score)
            )
        }
    ...
    fun generateDummyTvShows() : List<MoviesData> {
        val movies = ArrayList<MoviesData>()

        movies.add(
            MoviesData("1", "Rick and Morty", "2013", "Animation, Comedy, Sci-Fi & Fantasy, Action & Adventure","88%",
        ...
        movies.add(
            MoviesData("2", "Loki", "2021", "Drama, Sci-Fi & Fantasy\n","82%",
        ...
        movies.add(
            MoviesData("3","The Simpsons", "1989", "Family, Animation, Comedy", "79%",
        ...
        movies.add(
            MoviesData("4", "The Flash", "2014", "Drama, Sci-Fi & Fantasy", "77%",
        ...
        movies.add(
            MoviesData("8","Game of Thrones","2011","Sci-Fi & Fantasy, Drama, Action & Adventure","84%",
        ...
        movies.add(
            MoviesData("9","Miraculous: Tales of Ladybug & Cat Noir","2015","Action & Adventure, Animation, Kids","79%",
        ...
        movies.add(
            MoviesData("10","De Slimste Mens","2012","Talk","66%",
        ...
        movies.add(
            MoviesData("11","The Vampire Diaries","2009","Drama, Sci-Fi & Fantasy","83%",
        ...
        movies.add(
            MoviesData("12","The Falcon and the Winter Soldier","2021","Sci-Fi & Fantasy, Action & Adventure, Drama, War & Politics","78%",
    ...
    fun generateDummyTvRecommendation(idSelectedMovie: String): List<RecommendationData> {
        val dataRecommendation = ArrayList<RecommendationData>()
        val map = HashMap<Int, Int>()
        val listMovie = generateDummyTvShows()
        val sizeList = listMovie.size - 1
        var randomInt = Random.nextInt(0, sizeList)
        for (i in 1..5) {
            if (map.containsKey(randomInt) || listMovie[randomInt].moviesId == idSelectedMovie) {
